...
class todo:
    def __init__(self, root):
        self.root = root
        self.root.title('To-Do-Watch')
        self.root.geometry('650x410+300+150')

        self.label = Label(self.root, text='To-Do-Watch-App',
                           font='arial 25 bold', width=10, bd=5, bg='yellow', fg='black')
        self.label.pack(side='top', fill=BOTH)

        self.label2 = Label(self.root, text='Add Movie',
                            font='arial 18 bold', width=10, bd=5, bg='yellow', fg='black')
        self.label2.place(x=40, y=54)

        self.label3 = Label(self.root, text='Movies',
                            font='arial 18 bold', width=10, bd=5, bg='yellow', fg='black')
